...
<body>
    ...
    <div style="padding: 100px; color:white;" align='center'>
        <table>
            <tr style="background-color: black;">
                ...
                <td style="padding: 10px;padding-left:20px; font-size:20px;">Action</td>
            </tr>
            ...
            <tr style="background-color: grey;" align="center">
                ...
                <td style="padding:10px; padding-left: 20px"><a href="{{ url('deletecart',$carts->id) }}" class="btn btn-danger" role="button">Delete</a></td>
            </tr>
            @endforeach
        </table>
